...
const restoreBatches = (root: THREE.Group, batches: StaticBatch[]): void => {
  batches.forEach((batch) => {
    ...
    // Its dispose event is the only path that releases the instanceMatrix and
    // instanceColor GL buffers. It leaves the shared geometry and material alone.
    if (batch.mesh instanceof THREE.InstancedMesh) batch.mesh.dispose();
