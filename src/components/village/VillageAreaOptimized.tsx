...
const SimpleChurch: React.FC<{ position: [number, number, number]; rotation?: number }> =
...
const SimpleTownHall: React.FC<{ position: [number, number, number]; rotation?: number }> =
  React.memo(({ position, rotation = 0 }) => (
    <group position={position} rotation={[0, rotation, 0]}>
      {/* Main building */}
...
// Simplified school
const SimpleSchool: React.FC<{ position: [number, number, number]; rotation?: number }> =
  React.memo(({ position, rotation = 0 }) => (
    <group position={position} rotation={[0, rotation, 0]}>
      {/* Main building */}
...
const SimpleWishingWell: React.FC<{ position: [number, number, number] }> = React.memo(
  ({ position }) => (
...
// Fountain - simplified
const SimpleFountain: React.FC<{ position: [number, number, number] }> = React.memo(
  ({ position }) => (
    <group position={position}>
      {/* Base pool */}
...
const SimpleDuckPond: React.FC<{ position: [number, number, number] }> = React.memo(
  ({ position }) => (
    <group position={position}>
      {/* Shore */}
...
// Postbox - simplified
const SimplePostbox: React.FC<{ position: [number, number, number] }> = React.memo(
  ({ position }) => (
    <group position={position}>
