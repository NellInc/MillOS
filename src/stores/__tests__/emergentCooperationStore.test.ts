...
describe('emergentCooperationStore', () => {
    ...
    describe('attemptEmergentAction', () => {
        it('should return null or EmergentAction (never false)', () => {
            ...
            const result = state.attemptEmergentAction(
                'w1',
                'help_colleague',
                'w2',
                undefined
        ...
        it('should increment action count on successful action', () => {
            ...
            useEmergentCooperationStore.getState().attemptEmergentAction(
                'w1',
                'preventive_check',
                undefined,
                'machine-1'
    ...
    describe('getSelfOrganizingWorkers', () => {
        it('should return array of worker IDs with active actions', () => {
            useEmergentCooperationStore.setState({
                activeActions: [
                    { id: '1', workerId: 'w1', workerName: 'Marcus', taskType: 'help_colleague', description: '', startTime: 0, expectedDuration: 0, status: 'active', valueCreated: 'morale', wasObserved: false },
                    { id: '2', workerId: 'w2', workerName: 'Sarah', taskType: 'cleanup', description: '', startTime: 0, expectedDuration: 0, status: 'active', valueCreated: 'quality', wasObserved: false },
                ],
            });
