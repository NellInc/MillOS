...
describe('safetyReportStore', () => {
    ...
    describe('getReportingHealth', () => {
        ...
        it('should count pending reports', () => {
            useSafetyReportStore.setState({
                safetyReports: [
                    { id: '1', reporterId: 'w1', type: 'hazard', location: { x: 0, z: 0 }, description: '', severity: 'medium', timestamp: Date.now(), status: 'pending', shiftsUnaddressed: 0, wasAcknowledged: false },
                    { id: '2', reporterId: 'w2', type: 'near_miss', location: { x: 0, z: 0 }, description: '', severity: 'high', timestamp: Date.now(), status: 'pending', shiftsUnaddressed: 0, wasAcknowledged: false },
                ],
            });
